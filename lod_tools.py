...
class BLENDTOOLS_PT_Panel_lod(BlendTools_Panel, bpy.types.Panel):
...
class BLENDTOOLS_OT_Operator_updatelod(bpy.types.Operator):
...
class BLENDTOOLS_OT_Operator_lodify(bpy.types.Operator):
